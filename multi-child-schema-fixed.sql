-- Multi-Child Album Database Schema - Fixed Version
...
-- Note: Comment out these lines if you get foreign key errors and add them later
...
-- Create permissive RLS policies (security handled by PIN auth in app)
...
-- Insert default album settings for existing families (optional)
-- This will add default settings for any families that already exist
...
-- Success message
SELECT 'Multi-child schema created successfully! You can now use the admin dashboard.' as result;